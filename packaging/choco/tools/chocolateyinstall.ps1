...
$packageArgs = @{
    packageName    = 'spt'
    fileType       = 'msi'
    url64bit       = 'https://github.com/Mariana/ssh-perma-tunnel/releases/download/v26.1/spt-26.1-x86_64-pc-windows-msvc.msi'
    urlArm64       = 'https://github.com/Mariana/ssh-perma-tunnel/releases/download/v26.1/spt-26.1-aarch64-pc-windows-msvc.msi'
